        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <!--Titre de modal-->
                    ...
                    Adicionar Permissão para utilizador</h6>
                        ...
                        <!--LIBELLE DE LOCAL BUREAU ELECTORAL -->
                         ...
                         <div class="form-group  font-weight-bold text-dark ">
                            <label for="name">Permissão :</label>
                             ...
                             min="1" name="name"  placeholder="Digite Permissão de utilizador..." />
                        </div>
    ...
    <div class="row bg-white text- ">
        ...
        <div class="row float-right">
            ...
            <div class="d-flex  m-1">
                  <div class="btn-group-horizontal btn-group-xs">
                    <a href=" {{route('role.index')}}"  class="btn btn-sm btn-primary"> <i class="fas fa-user"></i> Perfis</a>
       ...
       <div class="row">
        ...
        <div class="table-responsive ">
            <table id="datatable"  class="table justify-content-center table-sm table-hover ">
                    ...
                    @foreach($permissions as $permission)
                        <tr class="">
                            ...
                            <td class='d-flex justify-content-center'>
                                <a href=" {{route('permission.show', $permission->id) }} "   class="btn btn-sm text-dark mr-2"> <i class="fas text-primary fa-cog"></i> <!--Modifier --></a>
                                <a href=" {{route('permission.edit', $permission->id) }} "   class="btn btn-sm text-info mr-2 "> <i class="fas text-primary fa-edit"></i> <!--Modifier --></a>
